 ...
 * @author alici
 */
@WebServlet(name = "MisProductos", urlPatterns = {"/MisProductos"})
public class MisProductos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession session = request.getSession();
        ...
        if (usuario == null ) {
            ...
            List<Product> listadoProductos = this.productFacade.findByVendorId(usuario.getUserId());
            request.setAttribute("listadoProductos", listadoProductos);

            rd = request.getRequestDispatcher("listadoMisProductos.jsp");
